// RenderPrototypePlugIn.h : main header file for the RenderPrototype plug-in.
//²å¼þµÄÉùÃ÷
...
class CRenderPrototypeRdkPlugIn;

// CRenderPrototypePlugIn
// See RenderPrototypePlugIn.cpp for the implementation of this class
//

class CRenderPrototypePlugIn : public CRhinoRenderPlugIn
{
public:
  ...
  // CRenderPrototypePlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CRenderPrototypePlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~CRenderPrototypePlugIn() = default;
...
private:
  ...
  CRenderPrototypeEventWatcher m_event_watcher;
  CRenderPrototypeRdkPlugIn* m_pRdkPlugIn;
